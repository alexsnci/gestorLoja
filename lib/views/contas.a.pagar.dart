...
class ContasAPagar extends StatefulWidget {
  const ContasAPagar({super.key});

  @override
  State<ContasAPagar> createState() => _ContasAPagarState();
}

class _ContasAPagarState extends State<ContasAPagar> {
  @override
